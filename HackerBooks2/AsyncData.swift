...
extension AsyncDataDelegate {
    ...
    public func asyncData(_ sender: AsyncData, didEndLoadingFrom url: URL, withImage image: UIImageView){}
...
extension AsyncData{
    func sendNotification(){
        ...
        let n = Notification(name: AsyncDataDidEndLoading, object: self, userInfo: ["url" : url, "data" : _data])
